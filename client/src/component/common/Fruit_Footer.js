            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget subscribe no-box">
                  ...
                  <p>
                    Discover a world of freshness at our fruit store, where
                    vibrant colors and irresistible flavors come together...
                  </p>
                </div>
              </div>
              ...
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget no-box">
                  ...
                  <p>
                    <a title="glorythemes" className=" text-primary">
                      Ph : 9788670978
                    </a>
                  </p>
                  <p>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <p>Copyright Fruits Store © 2023. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
